...
<div class="mx-auto max-w-7xl px-4">
	<div class="mt-20 text-center">
		...
		<p class="font-lexend mx-auto mt-6 max-w-[550px] font-light">
			<b>Laniva</b> combines habit tracking, shared shopping boards, recipe manager and travel planning
			into a single, simple workspace so you spend less time juggling tools.
		</p>
