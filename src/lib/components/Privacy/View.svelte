<div class="pb-60">
	<div class="mx-auto mt-10 max-w-[800px]">
		...
		<p class="mt-2 text-center">EFFECTIVE DATE: January 13th 2026</p>

		<div class="mt-14">
			<p>
				Laniva (“we,” “our,” or “us”) is committed to protecting your privacy. This Privacy Policy
				explains how your personal information is collected, used, and disclosed by Laniva. <br />
				<br /> This Privacy Policy applies to our website, and its associated subdomains (collectively,
				our “Service”) alongside our application, Laniva. By accessing or using our Service, you signify
			...
			<h2 class="mt-10 mb-4 text-4xl font-semibold">Definitions and key terms</h2>
			...
			<ul>
				...
				<li>
					● Company: when this policy mentions “Company,” “we,” “us,” or “our,” it refers to Laniva,
					that is responsible for your information under this Privacy Policy.
				</li>
				<li>
					● Country: where Laniva or the owners/founders of Laniva are based, in this case is
					Nigeria
				</li>
				<li>
					● Customer: refers to the company, organization or person that signs up to use the Laniva
				...
				<li>
					...
					device that can be used to visit Laniva and use the services.
				</li>
				...
				<li>
					● Personnel: refers to those individuals who are employed by Laniva or are under contract
				...
				<li>
					● Service: refers to the service provided by Laniva as described in the relative terms (if
				...
				<li>● Website: Laniva's site, which can be accessed via this URL: https://laniva.app/</li>

				<li>● You: a person or entity that is registered with Laniva to use the Services.</li>
			</ul>

			<h2 class="mt-10 mb-4 text-4xl font-semibold">What Information Do We Collect?</h2>
			...
			<h2 class="mt-10 mb-4 text-4xl font-semibold">
				When does Laniva use end user information from third parties?
			</h2>

			<p>
				Laniva will collect End User Data necessary to provide the Laniva services to our customers.
			...
			<h2 class="mt-10 mb-4 text-4xl font-semibold">
				When does Laniva use customer information from third parties?
			</h2>

			<p>
				We receive some information from the third parties when you contact us. For example, when
				you submit your email address to us to show interest in becoming a Laniva customer, we
				receive information from a third party that provides automated fraud detection services to
				Laniva. We also occasionally collect information that is made publicly available on social
			...
			<p>
				...
				enable them to perform these services for us and for you. <br /> <br />
			...
			<p>
				Laniva will collect personal information that you submit to us. We may also receive personal
				information about you from third parties as described above.
			</p>

			<h2 class="mt-10 mb-4 text-4xl font-semibold">How Do We Use The Information We Collect?</h2>
			...
			<h2 class="mt-10 mb-4 text-4xl font-semibold">How Do We Use Your Email Address?</h2>
			...
			<h2 class="mt-10 mb-4 text-4xl font-semibold">How Long Do We Keep Your Information?</h2>

			<p>
				We keep your information only so long as we need it to provide Laniva to you and fulfill the
			...
			<h2 class="mt-10 mb-4 text-4xl font-semibold">How Do We Protect Your Information?</h2>
			...
			<p>
				...
				any information you transmit to Laniva or guarantee that your information on the Service may
				not be accessed, disclosed, altered, or destroyed by a breach of any of our physical,
			...
			<p>
				Laniva is incorporated in Nigeria. Information collected via our website, through direct
			...
			<h2 class="mt-10 mb-4 text-4xl font-semibold">
				Is the information collected through the Laniva Service secure?
			</h2>
			...
			<h2 class="mt-10 mb-4 text-4xl font-semibold">Can I update or correct my information?</h2>

			<p>
				The rights you have to request updates or corrections to the information Laniva collects
				depend on your relationship with Laniva. Personnel may update or correct their information
				...
				Privacy Policy prior to such update, correction, change or deletion. To protect your privacy
				and security, we may take reasonable steps (such as requesting a unique password) to verify your
				identity before granting you profile access or making corrections. You are responsible for maintaining
				the secrecy of your unique password and account information at all times.
				<br /><br /> You should be aware that it is not technologically possible to remove each and every
				record of the information you have provided to us from our system. The need to back up our systems
				...
				as and to the extent reasonably and technically practicable. If you are an end user and wish
				to update, delete, or receive any information we have about you, you may do so by contacting
				the organization of which you are a customer.
			</p>

			<h2 class="mt-10 mb-4 text-4xl font-semibold">Sale of Business</h2>

			<p>
				We reserve the right to transfer information to a third party in the event of a sale, merger
				or other transfer of all or substantially all of the assets of Laniva or any of its
				Corporate Affiliates (as defined herein), or that portion of Laniva or any of its Corporate
			...
			<h2 class="mt-10 mb-4 text-4xl font-semibold">Affiliates</h2>
			...
			<p>
				...
				with Laniva, whether by ownership or otherwise. Any information relating to you that we
			...
			<h2 class="mt-10 mb-4 text-4xl font-semibold">Governing Law</h2>
			...
			<p>
				...
				<br /><br /> The laws of Nigeria, excluding its conflicts of law rules, shall govern this
				Agreement and your use of the website. Your use of the website may also be subject to other
				local, state, national, or international laws. <br /><br /> By using Laniva or contacting us
				directly, you signify your acceptance of this Privacy Policy. If you do not agree to this Privacy
				Policy, you should not engage with our website, or use our services. Continued use of the website,
				direct engagement with us, or following the posting of changes to this Privacy Policy that do
				not significantly affect the use or disclosure of your personal information will mean that you
				accept those changes.
			</p>

			<h2 class="mt-10 mb-4 text-4xl font-semibold">Your Consent</h2>

			<p>
				We've updated our Privacy Policy to provide you with complete transparency into what is
				being set when you visit our site and how it's being used. By using our Laniva, registering
				an account, or making a purchase, you hereby consent to our Privacy Policy and agree to its
				terms.
			</p>
			<h2 class="mt-10 mb-4 text-4xl font-semibold">Links to Other Websites</h2>

			<p>
				This Privacy Policy applies only to the Services. The Services may contain links to other
				websites not operated or controlled by Laniva. We are not responsible for the content,
			...
			<h2 class="mt-10 mb-4 text-4xl font-semibold">Cookies</h2>

			<p>
				Laniva uses "Cookies" to identify the areas of our website that you have visited. A Cookie
			...
			<h2 class="mt-10 mb-4 text-4xl font-semibold">Kids' Privacy</h2>
			<p>
				...
				without your permission, please contact Us. If We become aware that We have collected
				Personal Data from anyone under the age of 13 without verification of parental consent, We
				take steps to remove that information from Our servers.
			</p>

			<h2 class="mt-10 mb-4 text-4xl font-semibold">Changes To Our Privacy Policy</h2>
			<p>
			...
			<h2 class="mt-10 mb-4 text-4xl font-semibold">Third-Party Services</h2>
			<p>
				...
				services ("Third- Party Services"). You acknowledge and agree that Laniva shall not be
				...
				thereof. Laniva does not assume and shall not have any liability or responsibility to you or
				any other person or entity for any Third-Party Services. Third-Party Services and links
				thereto are provided solely as a convenience to you and you access and use them entirely at
			...
			<h2 class="mt-10 mb-4 text-4xl font-semibold">What is GDPR?</h2>
			...
			<h2 class="mt-10 mb-4 text-4xl font-semibold">What is personal data?</h2>
			<p>
			...
			<ul>
				...
				<li>
					...
					be used for that purpose. Organizations must specify why they need the personal data when
					they collect it.
				</li>
			...
			<h2 class="mt-10 mb-4 text-4xl font-semibold">Why is GDPR important?</h2>
			...
			<p>
				...
				thing to do. At Laniva we strongly believe that your data privacy is very important and we
			...
			<p>
				...
				Laniva processes or stores all personal data in fully vetted, DPA compliant vendors. We do
				...
				<br /><br /> We are aware that if you are working with EU customers, you need to be able to provide
				them with the ability to access, update, retrieve and remove personal data. We got you! We've
				been set up as self service from the start and have always given you access to your data and
				your customers data. Our customer support team is here for you to answer any questions you might
				have about working with the API.
			</p>

			<h2 class="mt-10 mb-4 text-4xl font-semibold">California Residents</h2>
			...
			<p>
				...
				above.
				<br /> <br /> We are also required to communicate information about rights California residents
			...
			<h2 class="mt-10 mb-4 text-4xl font-semibold">Contact Us</h2>

			<p>Don't hesitate to contact us if you have any questions.</p>
			<p class="flex gap-1">
				● Via Email:

				<a href="mailto:berylhive@gmail.com" class="text-blue-600"> berylhive@gmail.com </a>
			</p>
		</div>
	</div>
</div>
