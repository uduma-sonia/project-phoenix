...
<button class="block w-full" onclick={() => openAddBudgetModal(budgetInfo)}>
	<div class="retro_wrapper">
		<div class="retro_wrapper_inner_iwjd">
			...
			<div class="mt-2">
				<div class="relative mb-1 h-1.5 overflow-hidden rounded-lg border border-gray-400">
					<div
				...
				<div class="font-lexend text-13 flex items-center justify-between gap-2 font-light">
					<p>
						...
						{/if} <small> {usedPercentage || 0}%</small>
					</p>
					<p>
